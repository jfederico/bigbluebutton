...
target_dir = "#{recording_dir}/process/transcript/#{meeting_id}"
if not FileTest.directory?(target_dir)
  FileUtils.mkdir_p "#{log_dir}/transcript"
  logger = Logger.new("#{log_dir}/transcript/process-#{meeting_id}.log", 'daily' )
  BigBlueButton.logger = logger
  BigBlueButton.logger.info("Processing script transcript.rb")
  ...
  begin
    ...
    process_done = File.new("#{recording_dir}/status/processed/#{meeting_id}-transcript.done", "w")
